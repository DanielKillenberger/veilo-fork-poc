> **Archived README from July 10, 2026.** Original text below. The proving binaries it describes are absent from this checkout; the test uses synthetic local state, not cloned mainnet state. Read the [current disclosure](../README.md) for corrections and reproduction limits.
